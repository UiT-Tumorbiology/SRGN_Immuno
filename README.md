...
Here, we have analyzed RNA-sequencing and proteomics data to investigate the effect of Serglycin (SRGN) on immune modulation of macrophgages. Most of the analysis is done using R, with count matrices generated using CLC Genomics Workbench and MaxQuant.

For questions about the scripts, please contact [saikat.d.sajib@uit.no](mailto:saikat.d.sajib@uit.no)
